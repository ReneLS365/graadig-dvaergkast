...
| V15-03-design – Wave director design spec | ✅ færdig | docs-only spec i `docs/V15_WAVE_DIRECTOR.md`; implementation mangler |
...
(nu `V15-03-impl`) og følg dens Allowed/Forbidden/Acceptance fra `docs/V15_PLAN.md`.
